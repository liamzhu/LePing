...
static public class NGUIMenu
{
    ...
    private static void PixelPerfectSelection()
    {
    ...
    private static bool PixelPerfectSelectionValidation()
    {
    ...
    private static void AddBreaker123()
    { }

    [MenuItem("NGUI/Create/Anchor (Legacy)", false, 6)]
    private static void AddAnchor2()
    { Add<UIAnchor>(); }
    ...
    private static T Add<T>() where T : MonoBehaviour
    {
    ...
    private static bool Tween2a()
    { return (Selection.activeGameObject != null) && (Selection.activeGameObject.GetComponent<UIWidget>() != null); }

    [MenuItem("NGUI/Tween/Width", false, 8)]
    private static void Tween3()
    ...
    private static bool Tween3a()
    { return (Selection.activeGameObject != null) && (Selection.activeGameObject.GetComponent<UIWidget>() != null); }

    [MenuItem("NGUI/Tween/Height", false, 8)]
    private static void Tween4()
    ...
    private static bool Tween4a()
    { return (Selection.activeGameObject != null) && (Selection.activeGameObject.GetComponent<UIWidget>() != null); }

    [MenuItem("NGUI/Tween/Position", false, 8)]
    private static void Tween5()
    ...
    private static bool Tween5a()
    { return (Selection.activeGameObject != null); }

    [MenuItem("NGUI/Tween/Rotation", false, 8)]
    private static void Tween6()
    ...
    private static bool Tween6a()
    { return (Selection.activeGameObject != null); }

    [MenuItem("NGUI/Tween/Scale", false, 8)]
    private static void Tween7()
    ...
    private static bool Tween7a()
    { return (Selection.activeGameObject != null); }

    [MenuItem("NGUI/Tween/Transform", false, 8)]
    private static void Tween8()
    ...
    private static bool Tween8a()
    { return (Selection.activeGameObject != null); }

    [MenuItem("NGUI/Tween/Volume", false, 8)]
    private static void Tween9()
